        ...
        <section className="relative overflow-hidden bg-[oklch(0.988_0.0041_91.45)] py-16 px-6 font-sans">
            ...
            <div className="relative z-10 mx-auto max-w-4xl text-center">
                ...
                <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                    <a href="https://calendly.com/yash-hypeon/30min" className="group relative flex h-12 items-center justify-center overflow-hidden rounded-xl bg-black px-6 font-semibold text-white transition-all hover:scale-[1.02] active:scale-95">
                        Get the demo
                    </a>
