  ...
  return (
    <Section cols={1} className="font-sans">
      ...
      <div className="mx-auto flex max-w-4xl flex-col items-center">
        ...
        >
          <a href="https://calendly.com/yash-hypeon/30min" className="bg-[#0A0A0A] text-white px-7 py-3 rounded-xl font-semibold text-[15px] hover:bg-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl active:scale-95 inline-block">
            Get the demo
          </a>
        </motion.div>
