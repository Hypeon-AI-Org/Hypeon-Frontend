...
const faqs = [
  ...
  { question: "How accurate is the attribution coverage?", answer: "HypeOn achieves 80–85% attribution coverage on average. The remaining 15–20% is technically unavoidable without mandatory login — it covers customers who browse incognito, use iOS ITP, or switch devices without providing an email. Any tool claiming 100% attribution is using probabilistic modelling (guessing) or is inaccurate. We believe in transparent, honest attribution with confidence levels — so you know exactly how much to trust each data point.ur suite includes trend forecasting, customer sentiment analysis, and revenue-driving insights." },
