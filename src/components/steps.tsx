        ...
        <Section>
          <Cell>
                ...
                <div className="space-y-0">
                    {steps.map((step, index) => (
                        ...
                        >
                            ...
                            <p className="text-base sm:text-base font-medium leading-tight max-w-xs">
                                {step.text}
                            </p>
                        </div>
                    ))}
            ...
            <div className="mt-10 sm:mt-12 lg:mt-14 flex justify-center">
                <a href="https://calendly.com/yash-hypeon/30min" className="flex items-center justify-center gap-2 bg-black text-white px-5 sm:px-6 py-2.5 rounded-full text-sm font-semibold hover:bg-gray-800 transition-colors min-h-[44px] cursor-pointer">
